...
public class InvestmentReturns {
	...
	double goldReturnsAmount;
	double propertyReturnsPercentage;
	double propertyReutrnsAmount;
	double niftyReturnsPercentage;
	double niftyReturnsAmount;
	double ppfReturnsPercentage;
	double ppfReturnsAmount;
	double mfReturnsPercentage;
	...
	public double getGoldReturnsPercentage() {
		return goldReturnsPercentage;
	}
